...
public class progress_leaderboards {
    public static void main(String[] args) {
            ...
            Map<String, int[]> subjectConstraints = new HashMap<>();
        ...
        Map<String, Map<String, Integer>> userProgressMap = new HashMap<>();
    ...
    private static void enterUserProgress(Map<String, int[]> subjectConstraints,
    ...
    private static void displayUserProgress(Map<String, Map<String, Integer>> userProgressMap,
